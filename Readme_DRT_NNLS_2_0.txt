...
The mode of DRT calculation should be set ('real', 'imag', or 'imre'), see the line
...
to use the imaginary part. Write

mode = 'imre'

to use both the real and imaginary parts for the DRT calculaton.
